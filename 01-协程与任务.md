...
<font color='red'>asyncio.create\_task(coro)</font>
...
<font color='red'>coroutine asyncio.wait_for(aw, timeout, *, loop=None)</font>
  ...
  在 3.7 版更改: 当 aw 因超时被取消，`wait\_for` 会等待 aw 被取消。之前版本则将立即引发 asyncio.TimeoutError。

##简单等待##

<font color='red'>coroutine asyncio.wait(aws, *, loop=None, timeout=None, return\_when=ALL\_COMPLETED</font>
...
<font color='red'>asyncio.as\_completed(aws, *, loop=None, timeout=None)</font>
...
<font color='red'>asyncio.run\_coroutine\_threadsafe(coro, loop)</font>
...
<font color='red'>asyncio.current\_task(loop=None)</font>
